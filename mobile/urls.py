...
from mobile.views import MobileMatchParticipants, MobileMatchSendEmpower, MobileMatchSendMessage, MobileMatchAudio, MobileMatchGetAudio
...
urlpatterns = [
    ...
    url(r'^match/get-audio/$', MobileMatchGetAudio.as_view(), name='mobile_match_get_audio'),
]
